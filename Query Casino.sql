...
CREATE TABLE dbo.tipo_movimientos_contables (
  ...
  codigo nvarchar(32) NOT NULL UNIQUE,   -- Depositar, Mantener, apostar, ganar, Sotar, Sacar, Tasa, Devoluci�n
...
CREATE TABLE dbo.carteras (
  ...
  balance_cent bigint NOT NULL DEFAULT 0,   -- cache (opcional, pero �til)
...
CREATE TABLE dbo.contabilidad_cartera (
  ...
  monto_cent bigint NOT NULL,              -- siempre positivo; direcci�n la marca ledger_type
...
-- Evitar duplicados por idempotencia en movimientos cr�ticos:
...
CREATE TABLE dbo.rondas_juego (
  ...
  ronda_seq int NOT NULL,               -- 1..n dentro de la sesi�n
  empezada_en datetime2 NOT NULL DEFAULT SYSUTCDATETIME(),
  acabada_en datetime2 NULL,
